...
#
# git-tag-all-smgui - tag all StateMod GUI repositories
...
# Main StateMod GUI repository
mainRepo="cdss-app-statemodgui-java"
...
productVersion=$(cat $mainRepoFolder/src/DWR/StateModGUI/StateModGUI.java | grep -m 1 'String PROGRAM_VERSION' | cut -d '=' -f 2 | cut -d '(' -f 1 | tr -d " " | tr -d '"')
productName="StateModGUI"

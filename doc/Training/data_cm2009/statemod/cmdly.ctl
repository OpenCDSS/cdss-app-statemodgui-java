...
#        1975-2005 simulations including soil moisture accounting
#
 Upper Colorado River Basin
 Historic Diversions
    1975     : iystr   STARTING YEAR OF SIMULATION
    2005     : iyend   ENDING YEAR OF SIMULATION
  ...
  WYR        : cyr1    Year type (a5, All caps, right justified !!)
       ...
       8     : ichk    0 = off, 1=print river network,  -n= detailed printout at river node ichk
      -1     : ireopx  Re-operation switch (0=re-operate;1=no re-operation)
       ...
       1     : iday    Switch for daily calculations (0=monthly analysis; 1=daily analysis)
